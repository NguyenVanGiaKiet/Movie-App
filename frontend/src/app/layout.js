...
export const metadata = {
  title: 'CineStream – Xem phim trực tuyến',
        ...
        <AuthProvider>
          ...
          <footer className="bg-dark-surface border-t border-dark-border py-10 mt-20">
            <div className="max-w-7xl mx-auto px-4 text-center">
              <p className="font-display text-3xl text-brand-red tracking-widest mb-3">CINESTREAM</p>
              <p className="text-[#606070] text-sm">© 2024 CineStream. Dữ liệu từ phim.nguonc.com</p>
            </div>
          </footer>
          <Toaster
            position="top-right"
